...
That handoff enters `seo-keyword-selection` **directly**. It must not restart keyword discovery for the same confirmed candidate and must never route through `seo-keyword-discovery`.
